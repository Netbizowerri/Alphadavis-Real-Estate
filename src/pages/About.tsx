        ...
        <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 z-0">
            ...
            >
              <img
                src={HERO_IMAGE}
                alt="AlphaDavis Luxury Real Estate"
        ...
        <section className="py-24 bg-brand-light">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
              <div className="space-y-4">
                <span className="text-brand-accent font-black uppercase tracking-widest text-sm italic">The Alpha Code</span>
              ...
              <p className="text-brand-deep/40 max-w-sm font-medium uppercase tracking-tight text-sm">
                Our foundation is built on these core values that define our commitment to every client and stakeholder.
              </p>
            </div>
        ...
        <section className="pb-24 pt-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="relative overflow-hidden rounded-[3.5rem] bg-brand-deep p-12 md:p-24 text-center">
              ...
              <div className="absolute inset-0 z-0">
                <img src={HERO_IMAGE} className="w-full h-full object-cover opacity-20 filter grayscale" alt="Footer background" />
